...
public class BoostAdjuster {
    ...
    private static final String BG_CPU = SystemProperties.get("persist.sys.axion_cpu_bg", "0-3");
    private static final String DISPLAY_CPU = SystemProperties.get("persist.sys.axion_cpu_display", "0-5");
    private static final String NT_FG_CPU = SystemProperties.get("persist.sys.axion_cpu_unlimit_ui", "0-7");
