...
enum class WidgetAction(
    ...
    DATA(
        ...
        onClick = onClickLambda@{
            ...
            it.widgetFactory.updateWidgetState(it.widgetButtons[DATA] ?: return@onClickLambda, DATA, enabled)
        },
        onLongClick = { c, v -> c.showInternetDialog(v); true },
    ...
    RINGER(
        ...
        onClick = onClickLambda@{
            ...
            it.widgetFactory.updateWidgetState(it.widgetButtons[RINGER] ?: return@onClickLambda, RINGER, next == AudioManager.RINGER_MODE_VIBRATE)
        },
        registerCallback = {
    ...
    TORCH(
        ...
        onClick = onClickLambda@{
            ...
            runCatching {
                ...
                it.widgetFactory.updateWidgetState(it.widgetButtons[TORCH] ?: return@onClickLambda, TORCH, it.isFlashOn)
            }
        }
    ),
    HOTSPOT(
        ...
        onClick = onClickLambda@{
            ...
            it.widgetFactory.updateWidgetState(it.widgetButtons[HOTSPOT] ?: return@onClickLambda, HOTSPOT, newState)
        },
        onLongClick = { c, v -> c.showInternetDialog(v); true },
